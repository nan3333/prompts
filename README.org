...
[[./prompt-repositories.txt]]

The =prompt-repositories.txt= file is to help find other prompts repositories

Pen will use this as a discovery mechanism to expand its database of prompts.
...
** The =.prompt= (=prompt description=) file format
